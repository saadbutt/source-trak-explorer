...
export class CRUDService {
  ...
  async getTxList(
    ...
    let sqlTxList = ` select t.blockid,t.creator_msp_id,t.txhash,t.type,t.chaincodename,t.createdt,channel.name as channelName,
       (SELECT COUNT(*) FROM transactions t2 WHERE t2.blockid = t.blockid AND t2.channel_genesis_hash = t.channel_genesis_hash AND t2.network_name = t.network_name) as txcount from transactions as t
