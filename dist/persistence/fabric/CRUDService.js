...
class CRUDService {
     ...
     * @memberof CRUDService
     */
    getChannelGenesisHashByName(network_name, channelname) {
        return __awaiter(this, void 0, void 0, function* () {
            const channel = yield this.sql.getRowByPkOne(' select channel_genesis_hash from channel where name=$1 and network_name = $2 ', [channelname, network_name]);
            return channel;
        });
    }
    /**
    ...
    getChannelsInfo(network_name) {
        return __awaiter(this, void 0, void 0, function* () {
            const channels = yield this.sql.getRowsBySQlNoCondition(` SELECT c.id as id, c.name as channelName, c.blocks as blocks, c.channel_genesis_hash as channel_genesis_hash,
    ...
    isBlockAvailableInDB(channel_genesis_hash, blockHeight) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield this.sql.getRowsBySQlCase(`SELECT COUNT(*) FROM blocks WHERE channel_genesis_hash= $1 AND blocknum = $2`, [channel_genesis_hash, blockHeight]);
